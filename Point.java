...
public class Point implements Comparable{
    ...
    public int compareTo( Object otherObj){
        /* Use the Pythagorean theorem.
           ...
           Point objOther = (Point) otherObj;
           double d0 = Math.pow(xcor,2) + Math.pow(ycor,2);
           double d1 = Math.pow(objOther.xcor,2) + Math.pow(objOther.ycor,2);
           return Double.compare(d0,d1); // temp: all Points are One
    }
